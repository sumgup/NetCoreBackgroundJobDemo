...
namespace Microsoft.eShopOnContainers.BuildingBlocks.Resilience.Http
{
    ...
    public class ResilientHttpClient : IHttpClient
    {
        ...
        public Task<HttpResponseMessage> PostAsync<T>(string uri, T item, string authorizationToken,
             string authorizationMethod)
        {
            return PostToStripe(HttpMethod.Post, uri, item, authorizationToken, null, authorizationMethod);
        }
        ...
        private Task<HttpResponseMessage> PostToStripe<T>(HttpMethod method, string uri, T item, string authorizationToken = null, string requestId = null, string authorizationMethod = "Bearer")
        {
        ...
        public Task<HttpResponseMessage> PostToStripe(string uri, 
            Dictionary<string, string> values, string apiKey)
        {
